...
public class AutomaticGrader extends Thread {
    ...
    private ArrayBlockingQueue<Submission> gradedSubmissions;
     ...
     */
    public AutomaticGrader(List<Submission> ungradedSubmissions, ArrayBlockingQueue<Submission> gradedSubmissions) {
        super();
